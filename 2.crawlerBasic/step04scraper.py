...
1. 파이썬으로 스크래핑 흐름 이해하기
    ...
    - 실행후 books.db가 존재하는 경로인 이 파이썬 예제가 실행된 경로내에 존재하는 정보 검색
        >sqlite3 books.db
...
def scrape(html):
    ...
    for partial_html in re.findall(r'<td class="left"><a.*?</td>', html, re.DOTALL):
        #<td class="left">
        #   <a href="/store/books/look.php?p_code=B7198274060"
        ...
        print("###4. title: ", title) # title: 재미있고 빠른 한글 1권: 기본
...
def save(db_path, books):
    ...
    # executemany()메소드를 사용하면 매개변수로 리스트를 저장할 수 있음
